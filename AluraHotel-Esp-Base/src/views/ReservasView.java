...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblCheckOut.setBounds(68, 221, 212, 14);
		...
		lblTitulo.setBounds(94, 63, 245, 42);
		...
		lblValor.setBounds(72, 303, 227, 14);
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				calculavalor(txtFechaEntrada, txtFechaSalida);
			}

			private void calculavalor(JDateChooser FechaE, JDateChooser FechaS) {
				if (FechaE.getDate() != null && FechaS.getDate() != null) {
					Calendar inicio = FechaE.getCalendar();
					Calendar fin = FechaS.getCalendar();
					int dias = -1;
					int valorUnitario = 400;
					int precio;
					...
					precio = dias * valorUnitario;
					String precioTotal = Integer.toString(precio);
					txtValor.setText(precioTotal + " MXN");
				}
			}
		...
		txtValor.setBounds(78, 328, 261, 33);
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					...
					guardarReserva();
					JOptionPane.showMessageDialog(null, "La reserva ha sido guardada con éxito.");
					dispose();
